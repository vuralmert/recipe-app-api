...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is required the call API"""
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Mac and Cheese')
        r2 = create_recipe(user=self.user, title='Chicken Doner Kebab')
        in1 = Ingredient.objects.create(user=self.user, name='Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Chicken')
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='French Onion Soup')
